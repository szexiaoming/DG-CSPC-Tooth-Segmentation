...
def extract_patient_id(name: str) -> str:
    ...
    For STS 2024 naming like 'STS24_Train_Labeled_0001', the patient ID is derived from the numeric portion. 
    Since all 30 labeled images likely come from different patients, we just use the filename as a proxy.
