...
def json_to_mask(
    ...
    All tooth polygons (regardless of FDI label) are merged into a single
    foreground class (255=tooth, 0=background) for semantic segmentation.
...
def preprocess_mask(
    ...
    """
    Resize a binary mask using nearest-neighbor interpolation to preserve
    label boundaries.
